<template>
    <el-menu :default-active="activeMenu" class="side-menu" unique-opened @select="handelSelect">
        <el-sub-menu index="questionManage">
            ...
            <el-menu-item index="questionTeacher">
                <el-icon>
                    <Reading />
                </el-icon>
                <span>查看考题</span>
            </el-menu-item>
            <el-menu-item index="questionTeacherAdd">
                <el-icon>
                    <Plus />
                </el-icon>
                <span>新增考题</span>
        ...
        <el-sub-menu index="examManage">
            ...
            <el-menu-item index="examTeacher">
                <el-icon>
                    <DocumentChecked />
                </el-icon>
                <span>查看考试</span>
            </el-menu-item>
            <el-menu-item index="examTeacherAdd">
                <el-icon>
                    <DocumentAdd />
                </el-icon>
                <span>新增考试</span>
        ...
        <el-sub-menu index="studentManage">
            ...
            <el-menu-item index="studentTeacher">
                <el-icon>
                    <View />
                </el-icon>
                <span>查看学生</span>
            </el-menu-item>
            <el-menu-item index="studentTeacherAdd">
                <el-icon>
                    <Plus />
                </el-icon>
                <span>添加学生</span>
